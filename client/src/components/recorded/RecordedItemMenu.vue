    ...
    <div class="recorded-item-menu">
        <v-menu class="menu" v-model="isOpened" bottom left>
            ...
            <v-list>
                ...
                <v-list-item v-if="recordedItem.isRecording === true" v-on:click="openStopRecordingDialog">
                    <v-list-item-icon class="mr-3">
                        <v-icon>mdi-stop-circle-outline</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                        <v-list-item-title>stop rec</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
        ...
        <RecordedStopDialog :isOpen.sync="isOpenStopRecordingDialog" :recordedItem="recordedItem"></RecordedStopDialog>
    </div>
</template>
...
import RecordedStopDialog from '@/components/recorded/RecordedStopDialog.vue';
...
export default class RecordedItemMenu extends Vue {
    ...
    public isOpenStopRecordingDialog: boolean = false;
    ...
    public async openStopRecordingDialog(): Promise<void> {
        await Util.sleep(300);
        this.isOpenStopRecordingDialog = true;
    }
